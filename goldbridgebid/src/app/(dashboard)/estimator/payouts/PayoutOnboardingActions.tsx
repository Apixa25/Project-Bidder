...
import {
  beginEstimatorPayoutOnboarding,
  refreshEstimatorPayoutStatus,
} from "./actions";
          ...
          <button
            ...
            onClick={() =>
              startTransition(async () => {
                ...
                const result = await beginEstimatorPayoutOnboarding();
                if (result?.error) {
        ...
        <button
          ...
          onClick={() =>
            startTransition(async () => {
              ...
              const result = await refreshEstimatorPayoutStatus();
              if (result?.error) {
                setError(result.error);
                return;
              }
