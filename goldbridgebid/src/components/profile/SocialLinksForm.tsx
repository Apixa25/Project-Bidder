...
import { updateSocialLinks } from "@/app/(dashboard)/profile/social-actions";
import {
  Globe,
  Loader2,
  CheckCircle2,
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            type="url"
            name="facebook"
            defaultValue={links.facebook_url || ""}
        ...
        <div>
          ...
          <input
            type="url"
            name="linkedin"
            defaultValue={links.linkedin_url || ""}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            type="text"
            name="otherLabel"
            defaultValue={links.other_link_label || ""}
            placeholder="e.g. Yelp, Google Reviews, Portfolio"
            className="block w-full rounded-lg border border-border bg-surface px-4 py-2.5 text-sm text-text-primary placeholder:text-text-muted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
        </div>
        <div>
          ...
          <input
            type="url"
            name="otherUrl"
            defaultValue={links.other_link_url || ""}
            placeholder="https://..."
            className="block w-full rounded-lg border border-border bg-surface px-4 py-2.5 text-sm text-text-primary placeholder:text-text-muted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
        </div>
